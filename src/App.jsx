...
export default function App() {
  ...
  const activeVehicles = vehicles.filter((vehicle) => {
    ...
    return (
      Date.now() - new Date(vehicle.completed_date).getTime() <
      FOUR_DAYS
    );
  });
  ...
  async function addVehicle() {
    if (!decoded || !stock) {
      alert(
        "Decode a VIN and enter a stock number first."
      );
      return;
    }
  ...
  async function onDrop(e, status) {
    ...
    if (status === "In Progress") {
      ...
      setSafetyLocation(
        vehicle.safety_location || "Goodwills"
      );
  ...
  return (
    <div className="app">
      <header>
        <div className="brand">
          <img
            src="/goodwills-logo.png"
            alt="Goodwill's Used Cars"
          />
        ...
        <aside>
          ...
          {decoded && (
            <div className="decoded-box">
              <p>
                <b>Year:</b> {decoded.year}
              </p>

              <p>
                <b>Make:</b> {decoded.make}
              </p>

              <p>
                <b>Model:</b> {decoded.model}
              </p>

              <p>
                <b>Trim:</b> {decoded.trim}
              </p>

              <p>
                <b>Engine:</b> {decoded.engine}
              </p>

              <p>
                <b>Body:</b> {decoded.body}
              </p>
          ...
          <div className="stats-box">
            ...
            <div className="stat-card">
              ...
              <p>
                {averageSafetyTime.toFixed(1)} days
              </p>
            </div>
      ...
      {partsPopup && (
        <div className="modal-bg">
          <div className="modal">
            ...
            <p>
              Enter the parts being waited on:
            </p>
